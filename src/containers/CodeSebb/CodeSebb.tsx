...
const CodeSebb = () => {
  return (
    <div className="cs__whatgpt3 section__margin" id="about">
      <div className="cs__whatgpt3-feature">
        <Feature title="CodeSebb" text="My life in a snapshot."/>
      </div>
      <div className="cs__whatgpt3-heading">
        <h1 className="gradient__text">Student first, always.</h1>
        <p>About me</p>
      </div>
      <div className="cs__whatgpt3-container">
